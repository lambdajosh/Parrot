...
| `Parrot/ProfileTest.swift` | 1429 | `--profile-test`: headless logic harness, ~60 assertions |
...
| `Services/TranscriptionEngine.swift` | 1248 | On-device WhisperKit; `AudioSource` routing; live preview decode |
...
| `Views/MeetingDetailView.swift` | 1257 | Post-call tabs: transcript, insights, report; speaker naming popover + confirm card |
